# UChicago Analysis Facility Quickstart Guide

Here you will find instructions on how to login into the UChicago analysis
facility via SSH, where to start working (the analysis facility filesystems and
the roles of each), setting up the ATLAS environment and other tools.

Find the UChicago main page at [af.uchicago.edu](https://af.uchicago.edu/).
